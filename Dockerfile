...
ARG VITE_PRODUCTION_APP_BASE_URL=""
ARG VITE_APP_WEB_API_PREFIX="/api"
ARG VITE_APP_CONSOLE_API_PREFIX="/consoleapi"

ENV PNPM_HOME="/pnpm"
ENV PATH="$PNPM_HOME:$PATH"
ENV CI=true
ENV VITE_PRODUCTION_APP_BASE_URL="${VITE_PRODUCTION_APP_BASE_URL}"
ENV VITE_APP_WEB_API_PREFIX="${VITE_APP_WEB_API_PREFIX}"
ENV VITE_APP_CONSOLE_API_PREFIX="${VITE_APP_CONSOLE_API_PREFIX}"
